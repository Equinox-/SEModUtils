namespace Equinox.Utils.Stream
{
    public static class MemoryStreamExtensions {
        ...
        public static void Write(this MemoryStream stream, ref VRageMath.SymetricSerializableRange val)
        {
            stream.Write(ref val.Min);
            stream.Write(ref val.Max);
        }
        public static void Read(this MemoryStream stream, ref VRageMath.SymetricSerializableRange val)
        {
            stream.Read(ref val.Min);
            stream.Read(ref val.Max);
        }
        ...
        public static void Write(this MemoryStream stream, VRageMath.SymetricSerializableRange val)
        {
            stream.Write(ref val);
        }
        ...
        public static VRageMath.SymetricSerializableRange ReadSymetricSerializableRange(this MemoryStream stream)
        {
    ...
    public static class SerializerExtensions {
        ...
        public class SymetricSerializableRangeSerializer : Serializer<VRageMath.SymetricSerializableRange> {
            public static readonly SymetricSerializableRangeSerializer Instance = new SymetricSerializableRangeSerializer();
            public override void Read(ref VRageMath.SymetricSerializableRange val, MemoryStream stream)
            {
                stream.Read(ref val);
            }
            public override void Write(ref VRageMath.SymetricSerializableRange val, MemoryStream stream)
            {
                stream.Write(ref val);
            }
        }
        ...
        public static void RegisterBuiltinTypes()
        {
            ...
            SerializerRegistry.RegisterSerializer(SymetricSerializableRangeSerializer.Instance);
